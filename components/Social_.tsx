...
const Social_ = ({}:Social_Props) => {
    return ( 
        <div className={`w-[160px] min-h-screen absolute top-0 left-0 flex flex-col justify-center items-center pb-[50px] xl:opacity-100 opacity-0 xl:pointer-events-auto pointer-events-none`}>
        <FontAwesomeIcon
            icon={faFacebook}
